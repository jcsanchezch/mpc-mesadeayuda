...
class InfraestructuraSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($dependencias as $d) {
            DB::table('dependencias')->updateOrInsert(['origen_id' => $d['origen_id']], $d);
        }

        // ── Locales ───────────────────────────────────────────────────────────
        $locales = [
            ['nombre' => 'QHAPAC ÑAN',                    'direccion' => 'AV. DE LOS INCAS N° 253',                  'principal' => true,  'activo' => true],
            ['nombre' => 'CASA MIGUEL ESPINACH',          'direccion' => 'JR. CRUZ DE PIEDRA N° 613',               'principal' => false, 'activo' => true],
            ['nombre' => 'SERENAZGO',                     'direccion' => 'JR. CHANCHAMAYO Nº 1660',                 'principal' => false, 'activo' => true],
            ['nombre' => 'CENTRO MEDICO MUNICIPAL',       'direccion' => 'JR. ELMER FAUCETT N° 369',               'principal' => false, 'activo' => true],
            ['nombre' => 'CUNA JARDIN',                   'direccion' => 'JR. APURIMAC CDRA 10',                    'principal' => false, 'activo' => true],
            ['nombre' => 'REAL PLAZA',                    'direccion' => 'AV. EVITAMIENTO NORTE LOTE 1A',           'principal' => false, 'activo' => true],
            ['nombre' => 'SAN ROQUE',                     'direccion' => 'JR. SAN ROQUE',                           'principal' => false, 'activo' => true],
            ['nombre' => 'CASA DE LA JUVENTUD',           'direccion' => 'JR.HUANUCO Y JR. DOS DE MAYO',            'principal' => false, 'activo' => true],
            ['nombre' => 'CASA DE LA MUJER',              'direccion' => 'JR CHEPEN Y JR CHANCHAMAYO-2° COMISARIA PNP', 'principal' => false, 'activo' => true],
            ['nombre' => 'CEDIF',                         'direccion' => 'JR. JUNIN CDRA 1',                        'principal' => false, 'activo' => true],
            ['nombre' => 'ESTADIO MUNICIPAL',             'direccion' => 'JR. REVILLA PEREZ CDRA 2',               'principal' => false, 'activo' => true],
            ['nombre' => 'MAQUINARIA PESADA',             'direccion' => 'AV. ATAHUALPA N° 202',                    'principal' => false, 'activo' => true],
            ['nombre' => 'MERCADO CENTRAL DE CAJAMARCA',  'direccion' => 'JR. APURIMAC Y JR AMAZONAS',             'principal' => false, 'activo' => true],
            ['nombre' => 'VENECIA',                       'direccion' => 'VENECIA',                                 'principal' => false, 'activo' => true],
            ['nombre' => 'VASO DE LECHE',                 'direccion' => 'JR. GUADALUPE CDRA 4',                    'principal' => false, 'activo' => true],
            ['nombre' => 'PLAZA PECUARIA ISCOCONGA',      'direccion' => 'CARRETERA AL DISTRITO DE JESUS',          'principal' => false, 'activo' => true],
            ['nombre' => 'POLICIA MUNICIPAL',             'direccion' => 'JR. APURIMAC CDRA 10',                    'principal' => false, 'activo' => true],
            ['nombre' => 'EDUCACION, CULTURA Y DEPORTE',  'direccion' => 'JR. 11 DE FEBRERO',                       'principal' => false, 'activo' => true],
            ['nombre' => 'LA COLMENA',                    'direccion' => 'JR. FRATERNIDAD CDRA 8',                  'principal' => false, 'activo' => true],
        ];

        foreach ($locales as $l) {
            DB::table('locales')->updateOrInsert(['nombre' => $l['nombre']], $l);
        }
    }
}
